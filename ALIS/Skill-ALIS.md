...
1. **ALIS Master Developer Handbook (Canonical)** — primary source of truth
2. **Jira Epics & Stories (TEXT ONLY)** — implementation intent and scope
...
2. **Do not blur module boundaries**
3. **Do not bypass layers**
4. **Do not weaken governance to simplify code**
5. **Do not convert agents into helpers**
...
>
> ALIS is an institutional operating system.
> Mistakes do not fail silently — they become incidents.
