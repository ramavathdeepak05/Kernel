...
class HostelEligibilityService:
    ...
    @classmethod
    def generate_hostel_fee_invoice(
        cls, org_id: str, student_id: str, room_id: str, amount: float, actor_id: str
    ) -> dict[str, Any]:
        ...
        AuditLog.log(
            ...
            actor_id=actor_id,
            actor_role="system",
            entity_type="generate_hostel_fee_invoice",
            entity_id="",
            tenant_id=org_id,
            metadata={"source": "generate_hostel_fee_invoice"},
        )
    ...
    def process_clearance(
        cls, org_id: str, allocation_id: str, actor_id: str
    ) -> dict[str, Any]:
        ...
        AuditLog.log(
            ...
            entity_id="",
            tenant_id=org_id,
            metadata={"source": "process_clearance"},
        )
    ...
    def auto_block_overdue(cls, org_id: str) -> int:
        ...
        for row in overdue:
            ...
            AuditLog.log(
                ...
                actor_id="system",
                actor_role="system",
                entity_type="auto_block_overdue",
                entity_id="",
                tenant_id=org_id,
                metadata={"source": "auto_block_overdue"},
            )
            blocked += 1

        if blocked:
            logger.info(
                "SS-2: Blocked %d students for overdue library fines > 7 days", blocked
            )
        return blocked
...
class GrievanceWorkflowService:
    ...
    def classify_and_route(
        cls, org_id: str, grievance_id: str, category: str, severity: str, actor_id: str
    ) -> dict[str, Any]:
        ...
        AuditLog.log(
            ...
            actor_id=actor_id,
            actor_role="system",
            entity_type="classify_and_route",
            entity_id="",
            tenant_id=org_id,
            metadata={"source": "classify_and_route"},
        )
    ...
    @classmethod
    def record_hearing(
        cls, org_id: str, grievance_id: str, hearing_data: dict[str, Any], actor_id: str
    ) -> dict[str, Any]:
        ...
        AuditLog.log(
            ...
            entity_id="",
            tenant_id=org_id,
            metadata={"source": "record_hearing"},
        )
        return {"grievance_id": grievance_id, "status": "HEARING_COMPLETE"}

    @classmethod
    def resolve(
        cls, org_id: str, grievance_id: str, resolution: dict[str, Any], actor_id: str
    ) -> dict[str, Any]:
    ...
    @classmethod
    def escalate_to_ombudsperson(
        cls, org_id: str, grievance_id: str, actor_id: str
    ) -> dict[str, Any]:
        ...
        AuditLog.log(
            ...
            actor_id=actor_id,
            actor_role="system",
            entity_type="escalate_to_ombudsperson",
            entity_id="",
            tenant_id=org_id,
            metadata={"source": "escalate_to_ombudsperson"},
        )
...
class HealthServiceCompletions:
    ...
    def check_auto_referral_needed(cls, org_id: str) -> list[dict[str, Any]]:
        ...
        for s in students:
            ...
            AuditLog.log(
                ...
                actor_id="system",
                actor_role="system",
                entity_type="auto_referral_needed",
                entity_id="",
                tenant_id=org_id,
                metadata={"source": "check_auto_referral_needed"},
            )
            referrals.append(
                {"referral_id": ref_id, "student_id": str(s["student_id"])}
            )
    ...
    def trigger_medical_emergency(
        cls, org_id: str, student_id: str, details: str, actor_id: str
    ) -> dict[str, Any]:
        """
        ...
        AuditLog.log(
            ...
            actor_id=actor_id,
            actor_role="system",
            entity_type="trigger_medical_emergency",
            entity_id="",
            tenant_id=org_id,
            metadata={"source": "trigger_medical_emergency"},
        )
    ...
    @classmethod
    def issue_health_clearance(
        cls, org_id: str, student_id: str, actor_id: str
    ) -> dict[str, Any]:
        ...
        AuditLog.log(
            ...
            actor_id=actor_id,
            actor_role="system",
            entity_type="issue_health_clearance",
            entity_id="",
            tenant_id=org_id,
            metadata={"source": "issue_health_clearance"},
        )
