...
class CatchUpCohortWorkflow:
    ...
    def trigger(
        ...
        compressed_weeks = int(policy_engine.get_value(
            "academics.late_joiner_catchup_weeks", org_id, 2
        ))
        new_deadline = datetime.fromisoformat(joining_date) + timedelta(weeks=compressed_weeks)
        ...
        logger.info(
            ...
            student_id, joining_date, len(session_ids),
        )
