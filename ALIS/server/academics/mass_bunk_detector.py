...
class MassBunkDetector:
    ...
    def check_session(cls, org_id: str, session_id: str) -> Dict[str, Any]:
        ...
        """
        threshold = float(policy_engine.get_value(
            "academics.mass_bunk_threshold", org_id, 0.20
        ))
        ...
        stats = execute_query(
            ...
            """,
            (session_id, org_id), tenant_id=org_id,
        )
        ...
        if rate < threshold:
            ...
            logger.warning(
                ...
                session_id, rate * 100, threshold * 100,
            )
    ...
    @classmethod
    def hod_resolve(cls, org_id: str, session_id: str, decision: str, actor_id: str) -> Dict[str, Any]:
        """
...
class AdjunctSchedulingService:
    ...
    def submit_availability(
        cls, org_id: str, faculty_id: str, week_start: str, slots: List[Dict[str, Any]],
    ) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def get_availability(cls, org_id: str, faculty_id: str, week_start: str) -> List[Dict[str, Any]]:
        rows = execute_query(
            "SELECT slots FROM adjunct_availability "
            "WHERE org_id = %s AND faculty_id = %s AND week_start = %s",
            (org_id, faculty_id, week_start), tenant_id=org_id,
        )
    ...
    @classmethod
    def allocate_adhoc_slots(cls, org_id: str, faculty_id: str, course_id: str,
                              week_start: str, actor_id: str) -> Dict[str, Any]:
            ...
            execute_transaction([
                (
                    ...
                    (slot_id, org_id, course_id, faculty_id,
                     slot["day"], slot["start_time"], slot["end_time"], week_start),
                )
            ], tenant_id=org_id)
