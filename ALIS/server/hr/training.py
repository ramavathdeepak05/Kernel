...
class TrainingService:
    ...
    def create_program(
        ...
        AuditLog.log(
            ...
            tenant_id=org_id,
            metadata={"source": "create_program"},
        )
    ...
    @classmethod
    def enroll(
        cls, org_id: str, program_id: str, staff_id: str, actor_id: str
    ) -> dict[str, Any]:
            ...
            [
                ...
                """,
                    (
                        ...
                        program_id,
                        staff_id,
                        EnrollmentStatus.REGISTERED.value,
                        now,
                    ),
                )
            ],
        ...
        AuditLog.log(
            ...
            entity_id="",
            tenant_id=org_id,
            metadata={"source": "enroll"},
        )
        return {"id": enrollment_id, "status": EnrollmentStatus.REGISTERED.value}

    @classmethod
    def mark_completed(
        cls, org_id: str, enrollment_id: str, actor_id: str
    ) -> dict[str, Any]:
        execute_transaction(
            [
                (
        ...
        AuditLog.log(
            ...
            entity_id="",
            tenant_id=org_id,
            metadata={"source": "mark_completed"},
        )
    ...
    def schedule_effectiveness_assessment(cls, org_id: str, program_id: str) -> None:
        ...
        AuditLog.log(
            ...
            actor_id="system",
            actor_role="system",
            entity_type="schedule_effectiveness_assessment",
            entity_id="",
            tenant_id=org_id,
            metadata={"source": "schedule_effectiveness_assessment"},
        )
