...
class RecruitmentService:
    ...
    def check_ugc_eligibility(
        ...
        try:
            ...
            return {"eligible": True, "reason": "Non-UGC designation — no UGC check required"}
        ...
        if reqs["phd_required"] and not has_phd:
            ...
            checks["qualification"] = {"passed": False, "reason": "NET/SLET or PhD required"}
            eligible = False
        else:
    ...
    @classmethod
    def create_vacancy(cls, org_id: str, data: Dict[str, Any], actor_id: str) -> Dict[str, Any]:
    ...
    @classmethod
    def sanction_vacancy(cls, org_id: str, vacancy_id: str, actor_id: str) -> Dict[str, Any]:
        ...
        rows = execute_query(
            ...
            (vacancy_id, org_id), tenant_id=org_id,
        )
        if not rows:
        ...
        if rows[0]["budget_id"]:
            ...
            budget = execute_query(
                ...
                (rows[0]["budget_id"], org_id), tenant_id=org_id,
            )
        ...
        AuditLog.log(
            action=AuditAction.UPDATE, actor_id=actor_id, actor_role="admin",
            entity_type="vacancy", entity_id=vacancy_id, tenant_id=org_id,
    ...
    def screen_application(
        ...
        new_status = ApplicationStatus.ELIGIBLE.value if eligibility["eligible"] else ApplicationStatus.NOT_ELIGIBLE.value
        ...
        return {"application_id": application_id, "status": new_status, "eligibility": eligibility}
