    ...
    def get_compliance_dashboard(cls, org_id: str) -> dict[str, Any]:
        ...
        for p in programs:
            ...
            faculty_count = execute_query(
                ...
                (prog.get("code", prog["name"]), org_id),
                tenant_id=org_id,
            )
...
class NBAAccreditationService:
    ...
    def get_program_obe_status(cls, org_id: str, program_id: str) -> dict[str, Any]:
        ...
        above_60 = sum(
            1 for r in co_attainment if float(r.get("attainment_level", 0)) >= 60
        )
...
class AISHEDataService:
    ...
    def compile_aishe_data(cls, org_id: str, academic_year: str) -> dict[str, Any]:
        ...
        return {
            ...
            "enrollment": {
                "total_students": enrollment[0]["total"] if enrollment else 0
            },
            ...
            "examination_results": {
                ...
                "pass_rate": round(results[0]["passed"] / results[0]["total"] * 100, 1)
