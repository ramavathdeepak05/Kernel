...
export function OBEPage() {
  ...
  type TabKey = 'matrix' | 'attainment' | 'gaps' | 'export';
  ...
  return (
    <div style={{ minHeight: '100vh', background: COLORS.bg, color: COLORS.text, fontFamily: 'Inter, system-ui, sans-serif', padding: 32 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        {/* Tabs */}
        <ALISTabs defaultValue="matrix" onValueChange={(v) => setActiveTab(v as typeof activeTab)}>
          <ALISTabsList style={{ marginBottom: 28 }}>
            {tabs.map(t => (
          ...
          <ALISTabsContent value="attainment">
