...
This skill has three reference files. Each is large and task-specific. Do not load all three for every task — only load what your task needs.

```
alis-skill/
├── SKILL.md                          ← you are here — read first, always
└── references/
    ├── architecture.md               ← backend: stack, DB, events, RBAC, AI layer, APIs
    ├── edge-cases.md                 ← 32 edge case resolvers with SQL + Python implementations
    └── frontend.md                   ← UI shell, design system, agent-canvas sync, components
```
...
| New module (E14 Regulatory or beyond) | `references/architecture.md` §5 + §8 |
...
| Epic | Module | Status |
|---|---|---|
| E01 | Auth + Users + RBAC | Complete |
| E02 | Workflow Engine + Approvals | Complete |
| E03 | AI Gateway + Guardrails | Complete |
| E04 | Admissions (10 stages, 87 routes) | Complete |
| E05 | Academics (10 modules) | Complete |
| E06 | Examinations (12 stages) | Complete |
| E07 | Finance (7 domains) | Complete |
| E08 | HR & Payroll (6 domains) | Complete |
| E09 | Student Services (8 domains) | Complete |
| E10 | Communication Hub | Complete |
| E11 | Reporting & Analytics | Complete |
| E12 | Alumni & Placement | Complete |
| E13 | Dynamic Process Engine | Complete |
| **E14** | **Regulatory & Accreditation** | **NOT BUILT — build next** |
| **PAA** | **Policy Authoring Agent** | **NOT BUILT — see §10b in architecture.md** |
