...
**E14 is the highest priority new epic.** It is a pure event consumer — no mutations to source module data. See §15 for the event contract.
...
*For Claude Code use: read this file at the start of every session before writing any code.*
