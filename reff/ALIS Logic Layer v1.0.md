...
> The Institutional Logic Layer (ILL) described in this document is a design specification.
> It has not been implemented in the current codebase. Custom grading, fee, and payroll logic
> currently lives directly in module service files. The ILL (Logic Registry, sandboxed execution,
> GradingStrategy interface) is planned for a future hardening phase.
