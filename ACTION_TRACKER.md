...
| ID | Item | Src | Type | Status |
|----|------|-----|------|--------|
| ☐ W3-1 | Enterprise **MSA** | R §4 | human | TODO |
| ☐ W3-2 | **DPA** (data processing agreement) | R §4 | human | TODO |
| ☐ W3-3 | **SLA** with uptime credits | R §4 | human | TODO |
| ☐ W3-4 | Support tiers + order forms + finalized enterprise pricing | R §4 | human | TODO |
| ☐ W3-5 | Counsel sign-off on Terms/Privacy/Refunds (remove "draft" banners) | R §4 | human | TODO |
| ☐ W3-6 | **Cyber-liability / E&O insurance** | R §4 | human | TODO |
| ☐ W3-7 | Selling-entity / cross-border tax structure (VAT/GST) | R §4 | human | TODO |
| ☐ W3-8 | **Live Razorpay keys** (clear KYC) | R §4 | human | TODO |
...
| ID | Item | Src | Type | Status |
|----|------|-----|------|--------|
| ☐ W4-1 | **Observability/alerting/uptime monitoring** wired in prod (Sentry/Grafana) | R §5 | code/ops | TODO |
| ☐ W4-2 | **Status page** (enterprises require one) | R §5 | ops | TODO |
| ☐ W4-3 | **DR/BCP** with stated RTO/RPO + a *tested* restore runbook (Cloud SQL PITR exists, restore untested) | R §5 | ops | TODO |
| ☐ W4-4 | 24×7 on-call + defined support tiers | R §5 | human | TODO |
| ☐ W4-5 | Audit-log retention + **WORM** policy; documented key-rotation schedule / HSM custody | R §5 | code/ops | TODO |
| ☐ W4-6 | **Trust center / compliance portal** (certs, subprocessors, status, whitepaper) | R §3 | human+code | TODO |
| ☐ W4-7 | **CAIQ / SIG questionnaire** pre-answered (answer once, reuse) | R §3 | human | TODO |
| ☐ W4-8 | **Incident-response runbook + breach-notification** process (GDPR 72h, DPDP) | R §3 | human | TODO |
| ☐ W4-9 | **Vuln-management policy** with patch SLAs + continuous dependency scanning | R §3 | code/ops | TODO |
...
| ID | Item | Src | Type | Status |
|----|------|-----|------|--------|
| ☐ W5-1 | **Terraform the SaaS plane IaC** (currently manual; enterprise GCP TF exists) | R §2 | code | TODO |
| ☐ W5-2 | **Multi-region deploy** capability — EU region (no-US-egress), India DPDP localization, Gulf (KSA/UAE) | R §2 | code | TODO |
| ☐ W5-3 | **Validate** zero-egress VPC-SC/PrivateLink "prompts never touch public internet" topology at scale (specified, not proven) | R §2 | code | TODO |
| ☐ W5-4 | Documented per-region residency guarantees | R §2 | human | TODO |
